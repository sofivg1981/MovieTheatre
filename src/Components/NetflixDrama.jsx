...
const [pagina, setPagina] = useState(1);
  ...
  useEffect(() => {
    ...
    pagina + "&sort_by=popularity.desc&with_genres=18&watch_region=AR&with_watch_providers=8").then((data) => {
  ...
  return (
    ...
    <div class="resultadosPlataformas">
        ...
        <div className="etiquetasGenero">DRAMA</div>
    </div>
