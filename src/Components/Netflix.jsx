...
const [pagina, setPagina] = useState(1);
  ...
  return (
    ...
    <div class="resultadosPlataformas">
        <div>
        <Link to="/Netflix"><img class="logoPlataforma" src="https://venturebeat.com/wp-content/uploads/2016/06/netflix-logo.png?fit=2048%2C2048&strip=all"></img></Link>
        <div className="etiquetasGenero">TODOS LOS GÉNEROS</div>
    </div>
